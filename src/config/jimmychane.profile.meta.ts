...
export const PROFILE_JIMMYCHANE: ProfileModel = {
  name: 'Jimmy Chane',
  labels: ['Build website', 'Draw for fun'],
  socials: [
    { socialPlatform: SOCIAL_PLATFORM_TWITTER, href: 'https://twitter.com/jimmykajun' },
    { socialPlatform: SOCIAL_PLATFORM_TELEGRAM, href: 'https://t.me/Jimmy612' },
    { socialPlatform: SOCIAL_PLATFORM_GITHUB, href: 'https://github.com/JimmyChane' },
    { socialPlatform: SOCIAL_PLATFORM_BLUESKY, href: 'https://bsky.app/profile/jimmyfox.bsky.social' },
  ],
  description: 'Hi, feel free to chat with me',

  fursona: {
    image: FURSONA_PREVIEW_WEBP,
  ...
  skill: {
    ...
    categories: [
      ...
      { title: 'Serve website and API', skills: ['RESTful API', 'JSON', 'Express.js', 'MongoDB'] },
      { title: 'IDE', skills: ['Visual Studio Code', 'Android Studio', 'JetBrains IntelliJ'] },
