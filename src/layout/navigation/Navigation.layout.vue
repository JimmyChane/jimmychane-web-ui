...
<template>
  ...
  >
    ...
    <div ref="layoutBodyRef" class="NavigationLayout-body" style="z-index: 1">
      <AppActionbar
      ...
      <div class="NavigationLayout-router-view" style="z-index: 1">
